...
class BroadcastOptions_controller extends Controller
{
    public function index()
    {
        return "hellow it is  BroadCast options Api Bro";
    }
    public function Showall()
    {

        $Options = broadcast_options::all();
    ...
    public function Addnew(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'Question_id' => [
                'required',
                Rule::exists('broadcast_questions', 'id'),
            ],
        ]);
        ...
        if ($validator->fails()) {
            ...
            $existingOption = broadcast_options::where('Option_value', $request->Option_value)
            ...
            if ($existingOption) {
                ...
                $Option = broadcast_options::create([
                    'code' => $request->code,
    ...
    {
        $Option = broadcast_options::find($id);
        if ($Option) {
            return response()->json([
                'status' => 200,
                'Option' =>  $Option
    ...
    public function deleteAll()
    {
        ...
        DB::statement('ALTER TABLE broadcast_options AUTO_INCREMENT = 1');
        return response()->json([
            'status' => 200,
